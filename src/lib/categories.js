...
const monzo = {
    ...
    shopping: merchantCategory({
        ...
        'Kids:Baby Supplies': 'BIBADO',
        'Kids:Toys': 'Armadillo Toys',
        'Leisure:Toys & Games': /LH TRADING|NINTENDO/,
        'Shopping:Clothing': patterns.clothing,
    ...
    transport: merchantCategory({
        ...
        'Travel:Bus': /AUT BILET|MPSA|MEGABUS|STAGECOACH SERVICE|First Bus|FIRST WEST YORKSHIRE|TRANSDEV|BUS TICKET|CONNEXIONSBUS|WYMETRO| BUSES|FIRST BUS/,
